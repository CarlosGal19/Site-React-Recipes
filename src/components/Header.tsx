...
const Header: React.FC = () => {
    ...
    return (
        <nav
            className="relative flex w-full flex-nowrap items-center justify-between bg-sky-300 py-2 text-neutral-500 shadow-dark-mild hover:text-neutral-700 focus:text-neutral-700 dark:bg-zinc-950 lg:flex-wrap lg:justify-start lg:py-4"
            data-twe-navbar-ref>
                    ...
                    <ul
                        ...
                        <li>
                            <label className="inline-flex items-center cursor-pointer">
                                ...
                                />
                                <div className="relative w-11 h-6 bg-zinc-950 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-zinc-600 dark:peer-focus:ring-teal-800 rounded-full peer dark:bg-gray-700 peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all dark:border-zinc-950 peer-checked:bg-sky-500"></div>
